  ...
  return (
    <div>
      <div className='flex items-center gap-2 mb-2'>
        ...
        {isSurpriseMe ? (<button type='button' onClick={handleSurpriseMe} className='font-semibold text-xs bg-[#ececf1] py-1 px-2 rounded-[5px] text-black'>Surprise Me</button>) : null}
      </div>
